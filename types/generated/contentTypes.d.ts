...
export interface ApiOneNewsOneNews extends Schema.CollectionType {
  collectionName: 'news';
  info: {
  ...
  attributes: {
    ...
    type: Attribute.Relation<
      'api::one-news.one-news',
      'oneToOne',
      'api::type.type'
    >;
    titleImage: Attribute.Media & Attribute.Required;
...
export interface ApiStoryStory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    items: Attribute.DynamicZone<['image.image', 'video.video-item']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiUsersFsmUsersFsm extends Schema.CollectionType {
  collectionName: 'users_fsms';
  info: {
    singularName: 'users-fsm';
    pluralName: 'users-fsms';
    displayName: 'UsersFSM';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    fcm: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::users-fsm.users-fsm',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::one-news.one-news': ApiOneNewsOneNews;
      'api::story.story': ApiStoryStory;
      'api::type.type': ApiTypeType;
      'api::users-fsm.users-fsm': ApiUsersFsmUsersFsm;
    }
  }
}
